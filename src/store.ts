...
export default new Vuex.Store({
  ...
  articles: [
    ...
    },
    {
      ...
      category: "onderhoudArtikelen",
      icon: 'pipe-wrench',
      text1: 'WANNEER? \n De kleine onderhoudsbeurt wordt meestal om de 6.000 kilometer of in ieder geval jaarlijks uitgevoerd. Ook als je motor langere tijd heeft stilgestaan is het verstandig om een kleine beurt uit te (laten) voeren.  \n\n WAT KOST EEN KLEINE ONDERHOUDSBEURT? \n Gemiddeld kost een kleine beurt tussen de €100 en €200 euro. Onder een kleine beurt vallen voornamelijk het controleren van de motor (lichten, lagers, bandenspanning, ketting, scharnierpunten etc.), en vervangen van vloeistoffen en de oliefilter. De prijs van een kleine onderhoudsbeurt is daarom relatief laag. Maar mocht uit de controle blijken dat er iets mis of versleten is, dan wordt dit tegen meerprijs gerepareerd.  \n\n WAT ZIT ER IN EEN KLEINE ONDERHOUDSBEURT? \n Wij hebben alle onderdelen van een kleine onderhoudsbeurt op een rij gezet in onze kleine onderhoudsbeurt checklist. Bij ieder onderdeel in de checklist geven we aan hoe je dit zelf kan doen of waar je op moet letten als het door een garage laat doen. \n\n CHECKLIST \n -Vervangen van je motorolie en oliefilter \n -Remblokken en remvloeistof controleren en of vervangen  \n -Controle, spannen en smeren van je ketting \n -Controleren diverse lagers \n -Alles smeren \n -Koelvloeistof controleren \n -Controleren banden en bandenspanning \n -Controle elektrische systeem en verlichting',
      text2Head: 'Hoe?',
      text2: 'VERVANGEN VAN JE MOTOROLIE EN FILTER \n Olie in je motorblok zorgt voor smering van alle draaiende delen in je motorblok en voert vuil uit het blok af. Het oliefilter filtert de vuildeeltjes uit de olie. Na ongeveer 6000 kilometer is de olie in je motor toe aan vervanging. Laat de olie door je garage vervangen of vervang zelf je olie en oliefilter. \nLaat je dit doen? Het vervangen van de olie en de oliefilter zitten vaak inbegrepen in de kosten van een kleine beurt. \n\n CONTROLE, SPANNEN EN SMEREN VAN JE KETTING \n Als je ketting te slap staat krijgen je versnellingsbak en de lagers in je achterwiel het zwaar te verduren als je abrupt gas geeft. Een te strak gespannen ketting zal veel harder slijten en zorgt ervoor dat je motor niet lekker schakelt. Bij een kleine beurt wordt je ketting op de juiste spanning gezet en wordt de kwaliteit van je tandwielen gecontroleerd. \n\n REMBLOKKEN EN REMVLOEITSTOF CONTROLEREN EN OF VERVANGEN \n Al je met je motor remt, ontstaat er wrijving tussen de remschijf en de remblokken. Deze wrijving zorgt ervoor dat de schijf en de blokken langzaam afslijten. Omdat de blokken van zachter materiaal zijn gemaakt dan de remschijven, zullen de blokken eerder slijten. Met je motor rem je voornamelijk met je voorrem, zodat de remblokken voor harder zullen slijten. De mate van slijtage is ook afhankelijk van je rijstijl, de kwaliteit van de remblokken en het gewicht van je motorfiets. Het vervangen van remblokken of remschuiven en het ontluchten van je remleidingen is werk voor een ervaren klusser. \n Het controleren van de remblokken en vernieuwen van de remvloeistof zitten vaak in een kleine beurt. Het vervangen van de remblokken niet! \n\n CONTROLEREN DIVERSE LAGERS \n Lagers zie je niet, maar vormen een essentiële onderdeel van je motorfiets. De wiellagers zorgen er bijvoorbeeld voor dat de wielen van je motor soepel rond kunnen draaien. Versleten wiellagers kunnen ervoor zorgen dat het wiel in je motor kan bewegen. Dat wil je niet en dan zul je de wiellagers moeten laten vervagen. Ook in je stuur zitten lagers. Deze zogenaamde balhoofdlagers zorgen ervoor dat je soepel kunt sturen, ook bij lage snelheden. Het vervangen van lagers is geen klusje voor de onervaren klusser. \nHet controleren van de lagers zitten vaak in de beurt, het vervangen niet. Lees hier hoe het vervangen van balhoofdlagers in zijn werk gaat en je dit ook zelf kan doen.  \n\n  CONTROLE ELEKTRISCHE SYSTEEM EN VERLICHTING \n Bij een kleine beurt wordt gekeken of alle verlichting nog goed werkt. De accu wordt gecontroleerd en eventueel bijgevuld met gedemineraliseerd water. Kritische stekkerverbindingen, zoals de stekkers die van je spanningsregelaar en dynamo afkomen worden gecontroleerd en ingespoten met een siliconenspray of anti corrosie spray.',
      imgText: 'Onderhoud is alles',
      banner:  require('./assets/images/articles/onderhoud.jpg'),
      img1:  require('./assets/images/articles/olie.jpg'),
      img2:  require('./assets/images/articles/bobbins.jpg'),
      source: 'motoshare.eu',
      sourceLink: "https://motoshare.eu/nl-nl/ride/kleine-onderhoudsbeurt-van-je-motor"
    },
    {
      ...
      {
        title: "Quiz!",
        banner:  require('./assets/images/quiz/quiz.jpg'),
        category: "weekly",
